...
def accept_best_solution(user_id, exercise):
    ...
    for user_exercise in user_exercises:
        if user_exercise.status in [Solution.solutionStatus['SEND'],Solution.solutionStatus['ACTIVE']] and user_exercise.points >= points:
    ...
    for user_exercise in user_exercises:
        if user_exercise.status not in [Solution.solutionStatus['REFUSED'], Solution.solutionStatus['RUN_ERROR'], Solution.solutionStatus['REFUSED']]:
